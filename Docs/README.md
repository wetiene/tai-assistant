...
| [`live-tai-plan.md`](live-tai-plan.md) | Live Tai slice plan (operational; not constitutional) |
| [`ai-proxy-live-tai-contract.md`](ai-proxy-live-tai-contract.md) | Implementation contract for Live Tai via `POST /ai/coach` |
